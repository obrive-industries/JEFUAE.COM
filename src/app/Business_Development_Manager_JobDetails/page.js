export const metadata = {
    title: "Business Development Manager: Drive Growth & Strategic Partnerships",
    description:
        "Lead market expansion, foster client relationships, and implement growth strategies as a Business Development Manager, contributing to organizational success.",
    keywords:
        "Business Development Manager, market expansion, client relationships, growth strategies, strategic partnerships, sales leadership, revenue generation, business growth, B2B development, lead generation",
    alternates: {
        canonical: "https://www.jefuae.com/Business_Development_Manager_JobDetails",
    },
    openGraph: {
        url: "https://www.jefuae.com/Business_Development_Manager_JobDetails",
        description:
            "Lead market expansion, foster client relationships, and implement growth strategies as a Business Development Manager, contributing to organizational success.",
        siteName:
            "Business Development Manager: Drive Growth & Strategic Partnerships",
        title: "Business Development Manager: Drive Growth & Strategic Partnerships",
    },
};
        ...
        <section className="flex flex-col pb-10 w-[76%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow items-start mt-6 text-base text-stone-900 max-md:mt-10 max-md:max-w-full">
                ...
                <section>
                    ...
                    <h2 className="text-xl text-[#FF0000] font-light p-3 mt-8 border w-fit border-red-500">Regional BD Manager Middle East</h2>
